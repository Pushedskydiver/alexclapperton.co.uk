      ...
      <div class="container">
        ...
        <div class="siteBanner_flex">
          <div class="siteBanner_content">
            <h1 class="siteBanner_title">Love Manchester <br> website</h1>

            <!--================ - BREADCRUMBS - ================-->
            <?php include_once($path."breadcrumbs.php"); ?>

            <img class="siteBanner_img" src="/images/banner/love-manchester-frame.png" alt="" />
          </div>
        </div>
