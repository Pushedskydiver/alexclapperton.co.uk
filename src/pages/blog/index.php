      ...
      <div class="container">
        ...
        <div class="siteBanner_flex">
          <div class="siteBanner_content">
            ...
            <img class="siteBanner_img" src="/images/banner/wordpress-frame.png" alt="" />
          </div>
        </div>
    ...
    <main class="siteBlog  siteBlog--white" role="main">
      ...
      <div class="container">
        ...
        <div class="siteBlog_flex">
          ...
          <a class="siteBlog_item  siteBlog_item--noPadding" href="/blog/the-digital-industry-a-developers-perspective.php" title="Internal link to The Digital Industry: A Developer's Perspective blog post.">
          ...
          <!-- END : SITE BLOG ITEM /-->
          <!-- BEGIN : SITE BLOG ITEM -->
          <a class="siteBlog_item  siteBlog_item--noPadding" href="#">
